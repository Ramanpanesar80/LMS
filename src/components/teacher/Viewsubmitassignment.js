...
import { getStorage, getDownloadURL, ref } from "firebase/storage"; // Firebase Storage for download
import { Timestamp } from "firebase/firestore"; // Import Timestamp to handle Firebase date types
...
const TeacherViewAssignments = () => {
  ...
  // Fetch courses available to the teacher
  useEffect(() => {
